    ...
    public class SignUpService
    {
        public static string AddUser(UserModel user)
        {
            if (user != null)
            {
                try
                {
                    if (!string.IsNullOrWhiteSpace(user.EmailId) && !string.IsNullOrWhiteSpace(user.FirstName) && !IsEmailIdExists(user.EmailId))
                    {
        ...
        internal static string SendVerificationMail(string email)
        {
        ...
        private static void SendVerificationMail(UserModel user)
        {
            try
            {
                ...
                Settings.mailUtility.Send("Email Verification", html, user.EmailId, "", true);
            }
            catch (Exception e)
            {
                Logger.Log(e);
